package com.imooc.res.view.refresh;
...
import com.imooc.res.ui.view.refresh.CircleImageView;
import com.imooc.res.ui.view.refresh.MaterialProgressDrawable;
...
public class SwipeRefreshLayout extends SwipeRefresh {
    private com.imooc.res.ui.view.refresh.CircleImageView mBottomCircleView;
    ...
    private void createBottomProgressView() {
        mBottomCircleView = new com.imooc.res.ui.view.refresh.CircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
